...
def calculate_metrics(projects):
    ...
    for project in projects:
        ...
        roi = ((( cost - sum(cash_flows)) / sum(cash_flows)) * 100) if cost != 0 else 0
...
def calculate_single_metric(project, metric):
    ...
    if metric == "npv":
        ...
        roi = ((cost - (sum(cash_flows))) / cost) * 100 if cost != 0 else 0
        ...
        raise ValueError("Unknown metric. Try: npv, irr, roi, payback, bcr.")
